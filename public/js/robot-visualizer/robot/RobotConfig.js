...
export const ROBOT_6DOF_CONFIG = {
    ...
    joints: {
            ...
            children: [
                {
                    ...
                    position: { x: 0, y: 0, z: 75 }, // Z축 중심에서 높이/2만큼 위로
                    rotation: { x: -Math.PI / 2, y: 0, z: 0 }, // Z축 방향으로 세로 배치 (Y축→Z축)
                    material: 'link'
                },
                {
                    name: 'j1_horizontal',
        ...
        j2: {
            type: 'revolute',
            axis: 'y', // Y축 중심 회전 (shoulder pitch)
            range: [-90, 90],
            parent: 'j1',
            parentOffset: { x: 0, y: 50, z: 80 }, // J1 ㄱ자 끝
        ...
        j3: {
            type: 'revolute',
            axis: 'y', // Y축 중심 회전 (elbow pitch)
            range: [-90, 90],
            parent: 'j2',
            parentOffset: { x: 0, y: -40, z: 140 },
        ...
        j4: {
            type: 'revolute',
            axis: 'z', // Z축 중심 회전 (wrist roll)
            range: [-180, 180],
            parent: 'j3',
            parentOffset: { x: 0, y: 0, z: 45 },
